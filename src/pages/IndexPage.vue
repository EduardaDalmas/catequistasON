<template>
  ...
  <div class="sesion">
    ...
    <div class="text row">
      ...
      Este projeto trás ideias de atividades relacionadas aos temas trabalhados nas catequeses, que podem ser utilizadas pelos catequistas em suas catequeses, e também por pais e responsáveis em casa, para que a catequese não se restrinja apenas ao encontro semanal, mas que seja vivenciada no dia a dia.<br>
    </div>
  </div>
  <q-separator class="separator-design" />
  <div class="sesion row">
    <div class="col-4 col-md-6">
      <img src="~assets/eduarda.png" class="imagem_eduarda" alt="Eduarda Dalmás" />
    ...
    <div class="col-4 col-md-6">
      ...
      <div class="text">
        Olá, eu sou a &nbsp; <b> Eduarda Dalmás!</b>
        Catequista da Diocese de Novo Hamburgo desde 2021.
        Trabalho com desenvolvimento web e sempre tive o sonho de colocar este projeto em prática para ajudar os catequistas e catequizandos a terem uma catequese mais dinâmica e atrativa.<br />
        Me inspirei muito no Beato Carlo Acutis, que também desenvolveu projetos de evangelização na internet, e como ele mesmo dizia:
        <span class="highlight"><i>"Estar com Jesus, este é o meu plano de vida"</i>.</span> Beato Carlo Acutis, rogai por nós.
      </div>
    </div>
  </div>
</template>
